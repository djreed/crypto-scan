defmodule CryptoScanWeb.FollowControllerTest do
  use CryptoScanWeb.ConnCase

  alias CryptoScan.Connectors

  @create_attrs %{currency: "some currency", exchange: "some exchange"}
  ...
  def fixture(:follow) do
    {:ok, follow} = Connectors.create_follow(@create_attrs)
    follow
  end
